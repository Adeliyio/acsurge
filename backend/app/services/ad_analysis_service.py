...
class AdAnalysisService:
    ...
    async def analyze_ad(self, user_id: int, ad: AdInput, 
        ...
        clarity_analysis = self.readability_analyzer.analyze_clarity(full_text)
        emotion_analysis = self.emotion_analyzer.analyze_emotion(full_text)
        cta_analysis = self.cta_analyzer.analyze_cta(ad.cta, ad.platform)
